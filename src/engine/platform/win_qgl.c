...
qboolean QGL_Init( const char *dllname )
{
	...
	qglAccum                     = dllAccum = (decltype(dllAccum)) GPA("glAccum");
	qglAlphaFunc                 = dllAlphaFunc = (decltype(dllAlphaFunc))GPA("glAlphaFunc");
	qglAreTexturesResident       = dllAreTexturesResident = (decltype(dllAreTexturesResident))GPA("glAreTexturesResident");
	qglArrayElement              = dllArrayElement = (decltype(dllArrayElement))GPA("glArrayElement");
	qglBegin                     = dllBegin = (decltype(dllBegin))GPA("glBegin");
	qglBindTexture               = dllBindTexture = (decltype(dllBindTexture))GPA("glBindTexture");
	qglBitmap                    = dllBitmap = (decltype(dllBitmap))GPA("glBitmap");
	...
	qglCallLists                 = dllCallLists = (decltype(dllCallLists))GPA("glCallLists");
	qglClear                     = dllClear = (decltype(dllClear))GPA("glClear");
	qglClearAccum                = dllClearAccum = (decltype(dllClearAccum))GPA("glClearAccum");
	...
	qglClearIndex                = dllClearIndex = (decltype(dllClearIndex))GPA("glClearIndex");
	...
	qglColor3b                   = dllColor3b = (decltype(dllColor3b))GPA("glColor3b");
	qglColor3bv                  = dllColor3bv = (decltype(dllColor3bv))GPA("glColor3bv");
	qglColor3d                   = dllColor3d = (decltype(dllColor3d))GPA("glColor3d");
	qglColor3dv                  = dllColor3dv = (decltype(dllColor3dv))GPA("glColor3dv");
	qglColor3f                   = dllColor3f = (decltype(dllColor3f))GPA("glColor3f");
	qglColor3fv                  = dllColor3fv = (decltype(dllColor3fv))GPA("glColor3fv");
	qglColor3i                   = dllColor3i = (decltype(dllColor3i))GPA("glColor3i");
	qglColor3iv                  = dllColor3iv = (decltype(dllColor3iv))GPA("glColor3iv");
	qglColor3s                   = dllColor3s = (decltype(dllColor3s))GPA("glColor3s");
	qglColor3sv                  = dllColor3sv = (decltype(dllColor3sv))GPA("glColor3sv");
	qglColor3ub                  = dllColor3ub = (decltype(dllColor3ub))GPA("glColor3ub");
	qglColor3ubv                 = dllColor3ubv = (decltype(dllColor3ubv))GPA("glColor3ubv");
	qglColor3ui                  = dllColor3ui = (decltype(dllColor3ui))GPA("glColor3ui");
	qglColor3uiv                 = dllColor3uiv = (decltype(dllColor3uiv))GPA("glColor3uiv");
	qglColor3us                  = dllColor3us = (decltype(dllColor3us))GPA("glColor3us");
	qglColor3usv                 = dllColor3usv = (decltype(dllColor3usv))GPA("glColor3usv");
	qglColor4b                   = dllColor4b = (decltype(dllColor4b))GPA("glColor4b");
	qglColor4bv                  = dllColor4bv = (decltype(dllColor4bv))GPA("glColor4bv");
	qglColor4d                   = dllColor4d = (decltype(dllColor4d))GPA("glColor4d");
	qglColor4dv                  = dllColor4dv = (decltype(dllColor4dv))GPA("glColor4dv");
	qglColor4f                   = dllColor4f = (decltype(dllColor4f))GPA("glColor4f");
	qglColor4fv                  = dllColor4fv = (decltype(dllColor4fv))GPA("glColor4fv");
	qglColor4i                   = dllColor4i = (decltype(dllColor4i))GPA("glColor4i");
	qglColor4iv                  = dllColor4iv = (decltype(dllColor4iv))GPA("glColor4iv");
	qglColor4s                   = dllColor4s = (decltype(dllColor4s))GPA("glColor4s");
	qglColor4sv                  = dllColor4sv = (decltype(dllColor4sv))GPA("glColor4sv");
	qglColor4ub                  = dllColor4ub = (decltype(dllColor4ub))GPA("glColor4ub");
	qglColor4ubv                 = dllColor4ubv = (decltype(dllColor4ubv))GPA("glColor4ubv");
	qglColor4ui                  = dllColor4ui = (decltype(dllColor4ui))GPA("glColor4ui");
	qglColor4uiv                 = dllColor4uiv = (decltype(dllColor4uiv))GPA("glColor4uiv");
	qglColor4us                  = dllColor4us = (decltype(dllColor4us))GPA("glColor4us");
	qglColor4usv                 = dllColor4usv = (decltype(dllColor4usv))GPA("glColor4usv");
	qglColorMask                 = dllColorMask = (decltype(dllColorMask))GPA("glColorMask");
	qglColorMaterial             = dllColorMaterial = (decltype(dllColorMaterial))GPA("glColorMaterial");
	qglColorPointer              = dllColorPointer = (decltype(dllColorPointer))GPA("glColorPointer");
	qglCopyPixels                = dllCopyPixels = (decltype(dllCopyPixels))GPA("glCopyPixels");
	qglCopyTexImage1D            = dllCopyTexImage1D = (decltype(dllCopyTexImage1D))GPA("glCopyTexImage1D");
	qglCopyTexImage2D            = dllCopyTexImage2D = (decltype(dllCopyTexImage2D))GPA("glCopyTexImage2D");
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = (decltype(dllCopyTexSubImage1D))GPA("glCopyTexSubImage1D");
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = (decltype(dllCopyTexSubImage2D))GPA("glCopyTexSubImage2D");
	qglCullFace                  = dllCullFace = (decltype(dllCullFace))GPA("glCullFace");
	qglDeleteLists               = dllDeleteLists = (decltype(dllDeleteLists))GPA("glDeleteLists");
	...
	qglDrawArrays                = dllDrawArrays = (decltype(dllDrawArrays))GPA("glDrawArrays");
	...
	qglDrawPixels                = dllDrawPixels = (decltype(dllDrawPixels))GPA("glDrawPixels");
	qglEdgeFlag                  = dllEdgeFlag = (decltype(dllEdgeFlag))GPA("glEdgeFlag");
	qglEdgeFlagPointer           = dllEdgeFlagPointer = (decltype(dllEdgeFlagPointer))GPA("glEdgeFlagPointer");
	qglEdgeFlagv                 = dllEdgeFlagv = (decltype(dllEdgeFlagv))GPA("glEdgeFlagv");
	...
	qglEndList                   = 	dllEndList                   = (decltype(dllEndList))GPA("glEndList");
	qglEvalCoord1d				 = 	dllEvalCoord1d				 = (decltype(dllEvalCoord1d))GPA("glEvalCoord1d");
	qglEvalCoord1dv              = 	dllEvalCoord1dv              = (decltype(dllEvalCoord1dv))GPA("glEvalCoord1dv");
	qglEvalCoord1f               = 	dllEvalCoord1f               = (decltype(dllEvalCoord1f))GPA("glEvalCoord1f");
	qglEvalCoord1fv              = 	dllEvalCoord1fv              = (decltype(dllEvalCoord1fv))GPA("glEvalCoord1fv");
	qglEvalCoord2d               = 	dllEvalCoord2d               = (decltype(dllEvalCoord2d))GPA("glEvalCoord2d");
	qglEvalCoord2dv              = 	dllEvalCoord2dv              = (decltype(dllEvalCoord2dv))GPA("glEvalCoord2dv");
	qglEvalCoord2f               = 	dllEvalCoord2f               = (decltype(dllEvalCoord2f))GPA("glEvalCoord2f");
	qglEvalCoord2fv              = 	dllEvalCoord2fv              = (decltype(dllEvalCoord2fv))GPA("glEvalCoord2fv");
	qglEvalMesh1                 = 	dllEvalMesh1                 = (decltype(dllEvalMesh1))GPA("glEvalMesh1");
	qglEvalMesh2                 = 	dllEvalMesh2                 = (decltype(dllEvalMesh2))GPA("glEvalMesh2");
	qglEvalPoint1                = 	dllEvalPoint1                = (decltype(dllEvalPoint1))GPA("glEvalPoint1");
	qglEvalPoint2                = 	dllEvalPoint2                = (decltype(dllEvalPoint2))GPA("glEvalPoint2");
	qglFeedbackBuffer            = 	dllFeedbackBuffer            = (decltype(dllFeedbackBuffer))GPA("glFeedbackBuffer");
	qglFinish                    = 	dllFinish                    = (decltype(dllFinish))GPA("glFinish");
	qglFlush                     = 	dllFlush                     = (decltype(dllFlush))GPA("glFlush");
	qglFogf                      = 	dllFogf                      = (decltype(dllFogf))GPA("glFogf");
	qglFogfv                     = 	dllFogfv                     = (decltype(dllFogfv))GPA("glFogfv");
	qglFogi                      = 	dllFogi                      = (decltype(dllFogi))GPA("glFogi");
	qglFogiv                     = 	dllFogiv                     = (decltype(dllFogiv))GPA("glFogiv");
	qglFrontFace                 = 	dllFrontFace                 = (decltype(dllFrontFace))GPA("glFrontFace");
	qglFrustum                   = 	dllFrustum                   = (decltype(dllFrustum))GPA("glFrustum");
	qglGenLists                  = 	dllGenLists                  = ( GLuint (__stdcall * )(int) ) GPA( "glGenLists" );
	qglGenTextures               = 	dllGenTextures               = (decltype(dllGenTextures))GPA("glGenTextures");
	qglGetBooleanv               = 	dllGetBooleanv               = (decltype(dllGetBooleanv))GPA("glGetBooleanv");
	qglGetClipPlane              = 	dllGetClipPlane              = (decltype(dllGetClipPlane))GPA("glGetClipPlane");
	qglGetDoublev                = 	dllGetDoublev                = (decltype(dllGetDoublev))GPA("glGetDoublev");
	qglGetError                  = 	dllGetError                  = ( GLenum (__stdcall * )(void) ) GPA( "glGetError" );
	qglGetFloatv                 = 	dllGetFloatv                 = (decltype(dllGetFloatv))GPA("glGetFloatv");
	qglGetIntegerv               = 	dllGetIntegerv               = (decltype(dllGetIntegerv))GPA("glGetIntegerv");
	qglGetLightfv                = 	dllGetLightfv                = (decltype(dllGetLightfv))GPA("glGetLightfv");
	qglGetLightiv                = 	dllGetLightiv                = (decltype(dllGetLightiv))GPA("glGetLightiv");
	qglGetMapdv                  = 	dllGetMapdv                  = (decltype(dllGetMapdv))GPA("glGetMapdv");
	qglGetMapfv                  = 	dllGetMapfv                  = (decltype(dllGetMapfv))GPA("glGetMapfv");
	qglGetMapiv                  = 	dllGetMapiv                  = (decltype(dllGetMapiv))GPA("glGetMapiv");
	qglGetMaterialfv             = 	dllGetMaterialfv             = (decltype(dllGetMaterialfv))GPA("glGetMaterialfv");
	qglGetMaterialiv             = 	dllGetMaterialiv             = (decltype(dllGetMaterialiv))GPA("glGetMaterialiv");
	qglGetPixelMapfv             = 	dllGetPixelMapfv             = (decltype(dllGetPixelMapfv))GPA("glGetPixelMapfv");
	qglGetPixelMapuiv            = 	dllGetPixelMapuiv            = (decltype(dllGetPixelMapuiv))GPA("glGetPixelMapuiv");
	qglGetPixelMapusv            = 	dllGetPixelMapusv            = (decltype(dllGetPixelMapusv))GPA("glGetPixelMapusv");
	qglGetPointerv               = 	dllGetPointerv               = (decltype(dllGetPointerv))GPA("glGetPointerv");
	qglGetPolygonStipple         = 	dllGetPolygonStipple         = (decltype(dllGetPolygonStipple))GPA("glGetPolygonStipple");
	qglGetString                 = 	dllGetString                 = (decltype(dllGetString))GPA("glGetString");
	qglGetTexEnvfv               = 	dllGetTexEnvfv               = (decltype(dllGetTexEnvfv))GPA("glGetTexEnvfv");
	qglGetTexEnviv               = 	dllGetTexEnviv               = (decltype(dllGetTexEnviv))GPA("glGetTexEnviv");
	qglGetTexGendv               = 	dllGetTexGendv               = (decltype(dllGetTexGendv))GPA("glGetTexGendv");
	qglGetTexGenfv               = 	dllGetTexGenfv               = (decltype(dllGetTexGenfv))GPA("glGetTexGenfv");
	qglGetTexGeniv               = 	dllGetTexGeniv               = (decltype(dllGetTexGeniv))GPA("glGetTexGeniv");
	qglGetTexImage               = 	dllGetTexImage               = (decltype(dllGetTexImage))GPA("glGetTexImage");
	qglGetTexParameterfv         = 	dllGetTexParameterfv         = (decltype(dllGetTexParameterfv))GPA("glGetTexParameterfv");
	qglGetTexParameteriv         = 	dllGetTexParameteriv         = (decltype(dllGetTexParameteriv))GPA("glGetTexParameteriv");
	qglHint                      = 	dllHint                      = (decltype(dllHint))GPA("glHint");
	qglIndexMask                 = 	dllIndexMask                 = (decltype(dllIndexMask))GPA("glIndexMask");
	qglIndexPointer              = 	dllIndexPointer              = (decltype(dllIndexPointer))GPA("glIndexPointer");
	qglIndexd                    = 	dllIndexd                    = (decltype(dllIndexd))GPA("glIndexd");
	qglIndexdv                   = 	dllIndexdv                   = (decltype(dllIndexdv))GPA("glIndexdv");
	qglIndexf                    = 	dllIndexf                    = (decltype(dllIndexf))GPA("glIndexf");
	qglIndexfv                   = 	dllIndexfv                   = (decltype(dllIndexfv))GPA("glIndexfv");
	qglIndexi                    = 	dllIndexi                    = (decltype(dllIndexi))GPA("glIndexi");
	qglIndexiv                   = 	dllIndexiv                   = (decltype(dllIndexiv))GPA("glIndexiv");
	qglIndexs                    = 	dllIndexs                    = (decltype(dllIndexs))GPA("glIndexs");
	qglIndexsv                   = 	dllIndexsv                   = (decltype(dllIndexsv))GPA("glIndexsv");
	qglIndexub                   = 	dllIndexub                   = (decltype(dllIndexub))GPA("glIndexub");
	qglIndexubv                  = 	dllIndexubv                  = (decltype(dllIndexubv))GPA("glIndexubv");
	qglInitNames                 = 	dllInitNames                 = (decltype(dllInitNames))GPA("glInitNames");
	qglInterleavedArrays         = 	dllInterleavedArrays         = (decltype(dllInterleavedArrays))GPA("glInterleavedArrays");
	qglIsEnabled                 = 	dllIsEnabled                 = (decltype(dllIsEnabled))GPA("glIsEnabled");
	qglIsList                    = 	dllIsList                    = (decltype(dllIsList))GPA("glIsList");
	qglIsTexture                 = 	dllIsTexture                 = (decltype(dllIsTexture))GPA("glIsTexture");
	qglLightModelf               = 	dllLightModelf               = (decltype(dllLightModelf))GPA("glLightModelf");
	qglLightModelfv              = 	dllLightModelfv              = (decltype(dllLightModelfv))GPA("glLightModelfv");
	qglLightModeli               = 	dllLightModeli               = (decltype(dllLightModeli))GPA("glLightModeli");
	qglLightModeliv              = 	dllLightModeliv              = (decltype(dllLightModeliv))GPA("glLightModeliv");
	qglLightf                    = 	dllLightf                    = (decltype(dllLightf))GPA("glLightf");
	qglLightfv                   = 	dllLightfv                   = (decltype(dllLightfv))GPA("glLightfv");
	qglLighti                    = 	dllLighti                    = (decltype(dllLighti))GPA("glLighti");
	qglLightiv                   = 	dllLightiv                   = (decltype(dllLightiv))GPA("glLightiv");
	qglLineStipple               = 	dllLineStipple               = (decltype(dllLineStipple))GPA("glLineStipple");
	qglLineWidth                 = 	dllLineWidth                 = (decltype(dllLineWidth))GPA("glLineWidth");
	qglListBase                  = 	dllListBase                  = (decltype(dllListBase))GPA("glListBase");
	qglLoadIdentity              = 	dllLoadIdentity              = (decltype(dllLoadIdentity))GPA("glLoadIdentity");
	qglLoadMatrixd               = 	dllLoadMatrixd               = (decltype(dllLoadMatrixd))GPA("glLoadMatrixd");
	qglLoadMatrixf               = 	dllLoadMatrixf               = (decltype(dllLoadMatrixf))GPA("glLoadMatrixf");
	qglLoadName                  = 	dllLoadName                  = (decltype(dllLoadName))GPA("glLoadName");
	qglLogicOp                   = 	dllLogicOp                   = (decltype(dllLogicOp))GPA("glLogicOp");
	qglMap1d                     = 	dllMap1d                     = (decltype(dllMap1d))GPA("glMap1d");
	qglMap1f                     = 	dllMap1f                     = (decltype(dllMap1f))GPA("glMap1f");
	qglMap2d                     = 	dllMap2d                     = (decltype(dllMap2d))GPA("glMap2d");
	qglMap2f                     = 	dllMap2f                     = (decltype(dllMap2f))GPA("glMap2f");
	qglMapGrid1d                 = 	dllMapGrid1d                 = (decltype(dllMapGrid1d))GPA("glMapGrid1d");
	qglMapGrid1f                 = 	dllMapGrid1f                 = (decltype(dllMapGrid1f))GPA("glMapGrid1f");
	qglMapGrid2d                 = 	dllMapGrid2d                 = (decltype(dllMapGrid2d))GPA("glMapGrid2d");
	qglMapGrid2f                 = 	dllMapGrid2f                 = (decltype(dllMapGrid2f))GPA("glMapGrid2f");
	qglMaterialf                 = 	dllMaterialf                 = (decltype(dllMaterialf))GPA("glMaterialf");
	qglMaterialfv                = 	dllMaterialfv                = (decltype(dllMaterialfv))GPA("glMaterialfv");
	qglMateriali                 = 	dllMateriali                 = (decltype(dllMateriali))GPA("glMateriali");
	qglMaterialiv                = 	dllMaterialiv                = (decltype(dllMaterialiv))GPA("glMaterialiv");
	qglMatrixMode                = 	dllMatrixMode                = (decltype(dllMatrixMode))GPA("glMatrixMode");
	qglMultMatrixd               = 	dllMultMatrixd               = (decltype(dllMultMatrixd))GPA("glMultMatrixd");
	qglMultMatrixf               = 	dllMultMatrixf               = (decltype(dllMultMatrixf))GPA("glMultMatrixf");
	qglNewList                   = 	dllNewList                   = (decltype(dllNewList))GPA("glNewList");
	qglNormal3b                  = 	dllNormal3b                  = (decltype(dllNormal3b))GPA("glNormal3b");
	qglNormal3bv                 = 	dllNormal3bv                 = (decltype(dllNormal3bv))GPA("glNormal3bv");
	qglNormal3d                  = 	dllNormal3d                  = (decltype(dllNormal3d))GPA("glNormal3d");
	qglNormal3dv                 = 	dllNormal3dv                 = (decltype(dllNormal3dv))GPA("glNormal3dv");
	qglNormal3f                  = 	dllNormal3f                  = (decltype(dllNormal3f))GPA("glNormal3f");
	qglNormal3fv                 = 	dllNormal3fv                 = (decltype(dllNormal3fv))GPA("glNormal3fv");
	qglNormal3i                  = 	dllNormal3i                  = (decltype(dllNormal3i))GPA("glNormal3i");
	qglNormal3iv                 = 	dllNormal3iv                 = (decltype(dllNormal3iv))GPA("glNormal3iv");
	qglNormal3s                  = 	dllNormal3s                  = (decltype(dllNormal3s))GPA("glNormal3s");
	qglNormal3sv                 = 	dllNormal3sv                 = (decltype(dllNormal3sv))GPA("glNormal3sv");
	qglNormalPointer             = 	dllNormalPointer             = (decltype(dllNormalPointer))GPA("glNormalPointer");
	qglOrtho                     = 	dllOrtho                     = (decltype(dllOrtho))GPA("glOrtho");
	qglPassThrough               = 	dllPassThrough               = (decltype(dllPassThrough))GPA("glPassThrough");
	qglPixelMapfv                = 	dllPixelMapfv                = (decltype(dllPixelMapfv))GPA("glPixelMapfv");
	qglPixelMapuiv               = 	dllPixelMapuiv               = (decltype(dllPixelMapuiv))GPA("glPixelMapuiv");
	qglPixelMapusv               = 	dllPixelMapusv               = (decltype(dllPixelMapusv))GPA("glPixelMapusv");
	qglPixelStoref               = 	dllPixelStoref               = (decltype(dllPixelStoref))GPA("glPixelStoref");
	qglPixelStorei               = 	dllPixelStorei               = (decltype(dllPixelStorei))GPA("glPixelStorei");
	qglPixelTransferf            = 	dllPixelTransferf            = (decltype(dllPixelTransferf))GPA("glPixelTransferf");
	qglPixelTransferi            = 	dllPixelTransferi            = (decltype(dllPixelTransferi))GPA("glPixelTransferi");
	qglPixelZoom                 = 	dllPixelZoom                 = (decltype(dllPixelZoom))GPA("glPixelZoom");
	qglPointSize                 = 	dllPointSize                 = (decltype(dllPointSize))GPA("glPointSize");
	...
	qglPolygonStipple            = 	dllPolygonStipple            = (decltype(dllPolygonStipple))GPA("glPolygonStipple");
	qglPopAttrib                 = 	dllPopAttrib                 = (decltype(dllPopAttrib))GPA("glPopAttrib");
	qglPopClientAttrib           = 	dllPopClientAttrib           = (decltype(dllPopClientAttrib))GPA("glPopClientAttrib");
	qglPopMatrix                 = 	dllPopMatrix                 = (decltype(dllPopMatrix))GPA("glPopMatrix");
	qglPopName                   = 	dllPopName                   = (decltype(dllPopName))GPA("glPopName");
	qglPrioritizeTextures        = 	dllPrioritizeTextures        = (decltype(dllPrioritizeTextures))GPA("glPrioritizeTextures");
	qglPushAttrib                = 	dllPushAttrib                = (decltype(dllPushAttrib))GPA("glPushAttrib");
	qglPushClientAttrib          = 	dllPushClientAttrib          = (decltype(dllPushClientAttrib))GPA("glPushClientAttrib");
	qglPushMatrix                = 	dllPushMatrix                = (decltype(dllPushMatrix))GPA("glPushMatrix");
	qglPushName                  = 	dllPushName                  = (decltype(dllPushName))GPA("glPushName");
	qglRasterPos2d               = 	dllRasterPos2d               = (decltype(dllRasterPos2d))GPA("glRasterPos2d");
	qglRasterPos2dv              = 	dllRasterPos2dv              = (decltype(dllRasterPos2dv))GPA("glRasterPos2dv");
	qglRasterPos2f               = 	dllRasterPos2f               = (decltype(dllRasterPos2f))GPA("glRasterPos2f");
	qglRasterPos2fv              = 	dllRasterPos2fv              = (decltype(dllRasterPos2fv))GPA("glRasterPos2fv");
	qglRasterPos2i               = 	dllRasterPos2i               = (decltype(dllRasterPos2i))GPA("glRasterPos2i");
	qglRasterPos2iv              = 	dllRasterPos2iv              = (decltype(dllRasterPos2iv))GPA("glRasterPos2iv");
	qglRasterPos2s               = 	dllRasterPos2s               = (decltype(dllRasterPos2s))GPA("glRasterPos2s");
	qglRasterPos2sv              = 	dllRasterPos2sv              = (decltype(dllRasterPos2sv))GPA("glRasterPos2sv");
	qglRasterPos3d               = 	dllRasterPos3d               = (decltype(dllRasterPos3d))GPA("glRasterPos3d");
	qglRasterPos3dv              = 	dllRasterPos3dv              = (decltype(dllRasterPos3dv))GPA("glRasterPos3dv");
	qglRasterPos3f               = 	dllRasterPos3f               = (decltype(dllRasterPos3f))GPA("glRasterPos3f");
	qglRasterPos3fv              = 	dllRasterPos3fv              = (decltype(dllRasterPos3fv))GPA("glRasterPos3fv");
	qglRasterPos3i               = 	dllRasterPos3i               = (decltype(dllRasterPos3i))GPA("glRasterPos3i");
	qglRasterPos3iv              = 	dllRasterPos3iv              = (decltype(dllRasterPos3iv))GPA("glRasterPos3iv");
	qglRasterPos3s               = 	dllRasterPos3s               = (decltype(dllRasterPos3s))GPA("glRasterPos3s");
	qglRasterPos3sv              = 	dllRasterPos3sv              = (decltype(dllRasterPos3sv))GPA("glRasterPos3sv");
	qglRasterPos4d               = 	dllRasterPos4d               = (decltype(dllRasterPos4d))GPA("glRasterPos4d");
	qglRasterPos4dv              = 	dllRasterPos4dv              = (decltype(dllRasterPos4dv))GPA("glRasterPos4dv");
	qglRasterPos4f               = 	dllRasterPos4f               = (decltype(dllRasterPos4f))GPA("glRasterPos4f");
	qglRasterPos4fv              = 	dllRasterPos4fv              = (decltype(dllRasterPos4fv))GPA("glRasterPos4fv");
	qglRasterPos4i               = 	dllRasterPos4i               = (decltype(dllRasterPos4i))GPA("glRasterPos4i");
	qglRasterPos4iv              = 	dllRasterPos4iv              = (decltype(dllRasterPos4iv))GPA("glRasterPos4iv");
	qglRasterPos4s               = 	dllRasterPos4s               = (decltype(dllRasterPos4s))GPA("glRasterPos4s");
	qglRasterPos4sv              = 	dllRasterPos4sv              = (decltype(dllRasterPos4sv))GPA("glRasterPos4sv");
	qglReadBuffer                = 	dllReadBuffer                = (decltype(dllReadBuffer))GPA("glReadBuffer");
	qglReadPixels                = 	dllReadPixels                = (decltype(dllReadPixels))GPA("glReadPixels");
	qglRectd                     = 	dllRectd                     = (decltype(dllRectd))GPA("glRectd");
	qglRectdv                    = 	dllRectdv                    = (decltype(dllRectdv))GPA("glRectdv");
	qglRectf                     = 	dllRectf                     = (decltype(dllRectf))GPA("glRectf");
	qglRectfv                    = 	dllRectfv                    = (decltype(dllRectfv))GPA("glRectfv");
	qglRecti                     = 	dllRecti                     = (decltype(dllRecti))GPA("glRecti");
	qglRectiv                    = 	dllRectiv                    = (decltype(dllRectiv))GPA("glRectiv");
	qglRects                     = 	dllRects                     = (decltype(dllRects))GPA("glRects");
	qglRectsv                    = 	dllRectsv                    = (decltype(dllRectsv))GPA("glRectsv");
	qglRenderMode                = 	dllRenderMode                = (decltype(dllRenderMode))GPA("glRenderMode");
	qglRotated                   = 	dllRotated                   = (decltype(dllRotated))GPA("glRotated");
	qglRotatef                   = 	dllRotatef                   = (decltype(dllRotatef))GPA("glRotatef");
	qglScaled                    = 	dllScaled                    = (decltype(dllScaled))GPA("glScaled");
	qglScalef                    = 	dllScalef                    = (decltype(dllScalef))GPA("glScalef");
	qglScissor                   = 	dllScissor                   = (decltype(dllScissor))GPA("glScissor");
	qglSelectBuffer              = 	dllSelectBuffer              = (decltype(dllSelectBuffer))GPA("glSelectBuffer");
	...
	qglTexCoord1d                = 	dllTexCoord1d                = (decltype(dllTexCoord1d))GPA("glTexCoord1d");
	qglTexCoord1dv               = 	dllTexCoord1dv               = (decltype(dllTexCoord1dv))GPA("glTexCoord1dv");
	qglTexCoord1f                = 	dllTexCoord1f                = (decltype(dllTexCoord1f))GPA("glTexCoord1f");
	qglTexCoord1fv               = 	dllTexCoord1fv               = (decltype(dllTexCoord1fv))GPA("glTexCoord1fv");
	qglTexCoord1i                = 	dllTexCoord1i                = (decltype(dllTexCoord1i))GPA("glTexCoord1i");
	qglTexCoord1iv               = 	dllTexCoord1iv               = (decltype(dllTexCoord1iv))GPA("glTexCoord1iv");
	qglTexCoord1s                = 	dllTexCoord1s                = (decltype(dllTexCoord1s))GPA("glTexCoord1s");
	qglTexCoord1sv               = 	dllTexCoord1sv               = (decltype(dllTexCoord1sv))GPA("glTexCoord1sv");
	qglTexCoord2d                = 	dllTexCoord2d                = (decltype(dllTexCoord2d))GPA("glTexCoord2d");
	qglTexCoord2dv               = 	dllTexCoord2dv               = (decltype(dllTexCoord2dv))GPA("glTexCoord2dv");
	...
	qglTexCoord2i                = 	dllTexCoord2i                = (decltype(dllTexCoord2i))GPA("glTexCoord2i");
	qglTexCoord2iv               = 	dllTexCoord2iv               = (decltype(dllTexCoord2iv))GPA("glTexCoord2iv");
	qglTexCoord2s                = 	dllTexCoord2s                = (decltype(dllTexCoord2s))GPA("glTexCoord2s");
	qglTexCoord2sv               = 	dllTexCoord2sv               = (decltype(dllTexCoord2sv))GPA("glTexCoord2sv");
	qglTexCoord3d                = 	dllTexCoord3d                = (decltype(dllTexCoord3d))GPA("glTexCoord3d");
	qglTexCoord3dv               = 	dllTexCoord3dv               = (decltype(dllTexCoord3dv))GPA("glTexCoord3dv");
	qglTexCoord3f                = 	dllTexCoord3f                = (decltype(dllTexCoord3f))GPA("glTexCoord3f");
	qglTexCoord3fv               = 	dllTexCoord3fv               = (decltype(dllTexCoord3fv))GPA("glTexCoord3fv");
	qglTexCoord3i                = 	dllTexCoord3i                = (decltype(dllTexCoord3i))GPA("glTexCoord3i");
	qglTexCoord3iv               = 	dllTexCoord3iv               = (decltype(dllTexCoord3iv))GPA("glTexCoord3iv");
	qglTexCoord3s                = 	dllTexCoord3s                = (decltype(dllTexCoord3s))GPA("glTexCoord3s");
	qglTexCoord3sv               = 	dllTexCoord3sv               = (decltype(dllTexCoord3sv))GPA("glTexCoord3sv");
	qglTexCoord4d                = 	dllTexCoord4d                = (decltype(dllTexCoord4d))GPA("glTexCoord4d");
	qglTexCoord4dv               = 	dllTexCoord4dv               = (decltype(dllTexCoord4dv))GPA("glTexCoord4dv");
	qglTexCoord4f                = 	dllTexCoord4f                = (decltype(dllTexCoord4f))GPA("glTexCoord4f");
	qglTexCoord4fv               = 	dllTexCoord4fv               = (decltype(dllTexCoord4fv))GPA("glTexCoord4fv");
	qglTexCoord4i                = 	dllTexCoord4i                = (decltype(dllTexCoord4i))GPA("glTexCoord4i");
	qglTexCoord4iv               = 	dllTexCoord4iv               = (decltype(dllTexCoord4iv))GPA("glTexCoord4iv");
	qglTexCoord4s                = 	dllTexCoord4s                = (decltype(dllTexCoord4s))GPA("glTexCoord4s");
	qglTexCoord4sv               = 	dllTexCoord4sv               = (decltype(dllTexCoord4sv))GPA("glTexCoord4sv");
	...
	qglTexEnvfv                  = 	dllTexEnvfv                  = (decltype(dllTexEnvfv))GPA("glTexEnvfv");
	qglTexEnvi                   = 	dllTexEnvi                   = (decltype(dllTexEnvi))GPA("glTexEnvi");
	qglTexEnviv                  = 	dllTexEnviv                  = (decltype(dllTexEnviv))GPA("glTexEnviv");
	qglTexGend                   = 	dllTexGend                   = (decltype(dllTexGend))GPA("glTexGend");
	qglTexGendv                  = 	dllTexGendv                  = (decltype(dllTexGendv))GPA("glTexGendv");
	qglTexGenf                   = 	dllTexGenf                   = (decltype(dllTexGenf))GPA("glTexGenf");
	qglTexGenfv                  = 	dllTexGenfv                  = (decltype(dllTexGenfv))GPA("glTexGenfv");
	qglTexGeni                   = 	dllTexGeni                   = (decltype(dllTexGeni))GPA("glTexGeni");
	qglTexGeniv                  = 	dllTexGeniv                  = (decltype(dllTexGeniv))GPA("glTexGeniv");
	qglTexImage1D                = 	dllTexImage1D                = (decltype(dllTexImage1D))GPA("glTexImage1D");
	...
	qglTexParameteri             = 	dllTexParameteri             = (decltype(dllTexParameteri))GPA("glTexParameteri");
	qglTexParameteriv            = 	dllTexParameteriv            = (decltype(dllTexParameteriv))GPA("glTexParameteriv");
	qglTexSubImage1D             = 	dllTexSubImage1D             = (decltype(dllTexSubImage1D))GPA("glTexSubImage1D");
	qglTexSubImage2D             = 	dllTexSubImage2D             = (decltype(dllTexSubImage2D))GPA("glTexSubImage2D");
	qglTranslated                = 	dllTranslated                = (decltype(dllTranslated))GPA("glTranslated");
	qglTranslatef                = 	dllTranslatef                = (decltype(dllTranslatef))GPA("glTranslatef");
	qglVertex2d                  = 	dllVertex2d                  = (decltype(dllVertex2d))GPA("glVertex2d");
	qglVertex2dv                 = 	dllVertex2dv                 = (decltype(dllVertex2dv))GPA("glVertex2dv");
	qglVertex2f                  = 	dllVertex2f                  = (decltype(dllVertex2f))GPA("glVertex2f");
	qglVertex2fv                 = 	dllVertex2fv                 = (decltype(dllVertex2fv))GPA("glVertex2fv");
	qglVertex2i                  = 	dllVertex2i                  = (decltype(dllVertex2i))GPA("glVertex2i");
	qglVertex2iv                 = 	dllVertex2iv                 = (decltype(dllVertex2iv))GPA("glVertex2iv");
	qglVertex2s                  = 	dllVertex2s                  = (decltype(dllVertex2s))GPA("glVertex2s");
	qglVertex2sv                 = 	dllVertex2sv                 = (decltype(dllVertex2sv))GPA("glVertex2sv");
	qglVertex3d                  = 	dllVertex3d                  = (decltype(dllVertex3d))GPA("glVertex3d");
	qglVertex3dv                 = 	dllVertex3dv                 = (decltype(dllVertex3dv))GPA("glVertex3dv");
	...
	qglVertex3i                  = 	dllVertex3i                  = (decltype(dllVertex3i))GPA("glVertex3i");
	qglVertex3iv                 = 	dllVertex3iv                 = (decltype(dllVertex3iv))GPA("glVertex3iv");
	qglVertex3s                  = 	dllVertex3s                  = (decltype(dllVertex3s))GPA("glVertex3s");
	qglVertex3sv                 = 	dllVertex3sv                 = (decltype(dllVertex3sv))GPA("glVertex3sv");
	qglVertex4d                  = 	dllVertex4d                  = (decltype(dllVertex4d))GPA("glVertex4d");
	qglVertex4dv                 = 	dllVertex4dv                 = (decltype(dllVertex4dv))GPA("glVertex4dv");
	qglVertex4f                  = 	dllVertex4f                  = (decltype(dllVertex4f))GPA("glVertex4f");
	qglVertex4fv                 = 	dllVertex4fv                 = (decltype(dllVertex4fv))GPA("glVertex4fv");
	qglVertex4i                  = 	dllVertex4i                  = (decltype(dllVertex4i))GPA("glVertex4i");
	qglVertex4iv                 = 	dllVertex4iv                 = (decltype(dllVertex4iv))GPA("glVertex4iv");
	qglVertex4s                  = 	dllVertex4s                  = (decltype(dllVertex4s))GPA("glVertex4s");
	qglVertex4sv                 = 	dllVertex4sv                 = (decltype(dllVertex4sv))GPA("glVertex4sv");
	...
	qwglCopyContext              = (decltype(qwglCopyContext))GPA("wglCopyContext");
	qwglCreateContext            = (decltype(qwglCreateContext))GPA("wglCreateContext");
	qwglCreateLayerContext       = (decltype(qwglCreateLayerContext))GPA("wglCreateLayerContext");
	qwglDeleteContext            = (decltype(qwglDeleteContext))GPA("wglDeleteContext");
	qwglDescribeLayerPlane       = (decltype(qwglDescribeLayerPlane))GPA("wglDescribeLayerPlane");
	qwglGetCurrentContext        = (decltype(qwglGetCurrentContext))GPA("wglGetCurrentContext");
	qwglGetCurrentDC             = (decltype(qwglGetCurrentDC))GPA("wglGetCurrentDC");
	qwglGetLayerPaletteEntries   = (decltype(qwglGetLayerPaletteEntries))GPA("wglGetLayerPaletteEntries");
	...
	qwglRealizeLayerPalette      = (decltype(qwglRealizeLayerPalette))GPA("wglRealizeLayerPalette");
	qwglSetLayerPaletteEntries   = (decltype(qwglSetLayerPaletteEntries))GPA("wglSetLayerPaletteEntries");
	qwglShareLists               = (decltype(qwglShareLists))GPA("wglShareLists");
	qwglSwapLayerBuffers         = (decltype(qwglSwapLayerBuffers))GPA("wglSwapLayerBuffers");
	qwglUseFontBitmaps           = (decltype(qwglUseFontBitmaps))GPA("wglUseFontBitmapsA");
	qwglUseFontOutlines          = (decltype(qwglUseFontOutlines))GPA("wglUseFontOutlinesA");

	qwglChoosePixelFormat        = (decltype(qwglChoosePixelFormat))GPA("wglChoosePixelFormat");
	qwglDescribePixelFormat      = (decltype(qwglDescribePixelFormat))GPA("wglDescribePixelFormat");
	qwglGetPixelFormat           = (decltype(qwglGetPixelFormat))GPA("wglGetPixelFormat");
	qwglSetPixelFormat           = (decltype(qwglSetPixelFormat))GPA("wglSetPixelFormat");
	qwglSwapBuffers              = (decltype(qwglSwapBuffers))GPA("wglSwapBuffers");
